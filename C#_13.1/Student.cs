...
namespace C__13._1
{
    internal class Student
    {
        ...
        public event MyEventHandler Oversleep;
        public event MyEventHandler GetGun;
        public event MyEventHandler PassTheExam;
        ...
        public void OversleepLesson()
        {
            Console.WriteLine("Студент " + this.firstname + " " + this.lastname + " " + "Проспает пару!");
        }

        public void GetAGun()
        {
            Console.WriteLine("Студент " + this.firstname + " " + this.lastname + " " + "Получает автомат!");
        }

        public void PassTheExams()
        {
            Console.WriteLine("Студент " + this.firstname + " " + this.lastname + " " + "Сдает экзамен!");
        }

        public void StartEventOversleep()
        {
            if (Oversleep != null) Oversleep();
        }

        public void StartEventGetGun()
        {
            if (GetGun != null) GetGun();
        }

        public void StartEventPassTheExam()
        {
            if (PassTheExam != null) PassTheExam();
        }
    }
